...
public class ThirdPersonMovement : MonoBehaviour
{
    ...
    public bool plantBook;
    public bool fireBook;
    public bool waterBook;
    ...
    private void Start()
    {
        ...
        menu = pieMenu.GetComponentInChildren<MenuScript>();
    }
    ...
    void Update()
    {
        ...
        if (plantBook || fireBook || waterBook)
        {
            canSpell = true;
        }
        if (idle)
    ...
    public void Attacking()
    {
        ...
        if (Input.GetKeyDown("q") && mana > 99 && canSpell)
        {
        ...
        if (Input.GetKeyDown("1") && fireBook)
        {
            gun.element = 1;
            menu.SelectElement(1);
        }
        if (Input.GetKeyDown("2") && waterBook)
        {
            gun.element = 2;
            menu.SelectElement(2);
        }
        if (Input.GetKeyDown("3") && plantBook)
        {
            gun.element = 3;
            menu.SelectElement(3);
        }
    ...
    {
        var slashObj = Instantiate(slashVFX, slashPoint.position, Quaternion.Euler(90, cam.eulerAngles.y - 90, 0)) as GameObject;
    }
